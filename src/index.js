...
import FederalWitholding from './components/Payroll_Taxes/Federal_Witholding_Calculator';
class App extends Component {
  constructor(props) {
    super(props);
    
    this.state = { status: 'married-filing-joint', GI: 150000, AGI: 108370,
    federalWitholding: { GI: 26000, allowances: 2, frequency: 'weekly' },
    credits: { AGI: 4000, dependents: 2, qualifiedExpenses: 90000 }
    };
